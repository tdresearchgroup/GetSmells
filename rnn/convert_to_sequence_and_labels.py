...
CLASSES_OUTPUT_FILENAME = PROJECT_NAME + '_class_output'
CLASS_DICT_FILENAME = PROJECT_NAME + '_class_dict'
ALL_SOURCES_WORDS_FILENAME = PROJECT_NAME + '_all_sources_words'

if __name__ == "__main__":
		
	# read preprocessed data
	with open(CLASSES_OUTPUT_FILENAME, 'rb') as fp:
		# load dictionary
	    classes_output = pickle.load(fp)

	with open(ALL_SOURCES_WORDS_FILENAME, 'rb') as fp:
		# load array
		all_sources_words = pickle.load(fp)

	with open(CLASS_DICT_FILENAME, 'rb') as fp:
